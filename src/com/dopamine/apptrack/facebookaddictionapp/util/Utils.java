...
import com.dopamine.apptrack.facebookaddictionapp.activity.MainActivity;
...
public class Utils {
	 ...
	 * 
	 * 
	 * Self-note: use this class to ensure only 1 instance of any class is running
	 * 
	 */
	@TargetApi(11)
	public static void enableStrictMode() {
		...
		if (Utils.hasGingerbread()) {
			...
			if (Utils.hasHoneycomb()) {
				...
				// ADD ACTIVITIES HERE TO PREVENT MEMORY LEAK
			}
